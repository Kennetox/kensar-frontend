...
export default function LandingPage() {
  return (
    <>
      ...
      <main className={`${inter.className} relative min-h-screen bg-transparent text-[#0F172A]`}>
        ...
        <Link
          ...
          className={`${manrope.className} fixed bottom-4 right-4 z-40 rounded-full bg-[#0F172A] px-5 py-3 text-sm font-semibold text-white shadow-2xl transition hover:scale-[1.02] sm:bottom-8 sm:right-8`}
        >
